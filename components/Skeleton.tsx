export function SetlistCardSkeleton() {
  return (
    <div className="block bg-white rounded-2xl p-5 border border-gray-100 animate-pulse">
...
export function TrackRowSkeleton() {
  return (
    <div className="flex items-center gap-3 bg-white rounded-xl p-3 border border-gray-100 animate-pulse">
      <div className="w-5 h-4 bg-gray-100 rounded shrink-0" />
