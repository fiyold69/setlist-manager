...
export default function TrackSearch({
  ...
  return (
    <div>
      ...
      {searching && (
        <p className="text-center text-gray-400 dark:text-gray-500 text-sm py-4">検索中...</p>
      )}
        ...
        {results.map((track) => (
          ...
          >
            ...
            <button
              ...
              className="text-indigo-600 dark:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/50 text-sm font-medium px-3 py-1.5 rounded-lg transition-colors shrink-0"
            >
              + 追加
            </button>
          </div>
